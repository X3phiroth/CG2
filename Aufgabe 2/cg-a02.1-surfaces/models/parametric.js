            ...
            var ParametricSurface = function (posFunc, config) {
                ...
                for (var i = 0; i <= usegments; i++) {
                    ...
                    for (var j = 0; j <= vsegments; j++) {
                        ...
                        this.positions[c] = this.posFunc(umin_temp, vmin_temp)[0]; // i * usegments + j
                        c++;
                        this.positions[c] = this.posFunc(umin_temp, vmin_temp)[1]; // i * usegments + j + 1
                        c++;
                        this.positions[c] = this.posFunc(umin_temp, vmin_temp)[2]; // i * usegments + j + 2
                        c++;
                    };
                };
                ...
                for (var j = 0; j < this.positions.length; j+=3) {
