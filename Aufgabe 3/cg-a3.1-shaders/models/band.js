...
define(["three"], (function (THREE) {
    ...
    var Band = function (config) {
        ...
        for (var i = 0; i < this.indices.length; i += 6) {
            this.indices[  i  ] = c;
            this.indices[i + 1] = c + 1;
            this.indices[i + 2] = c + 3;

            this.indices[i + 3] = c;
            this.indices[i + 4] = c + 3;
            this.indices[i + 5] = c + 2;

            c += 2;
        }
        this.indices[this.indices.length - 4] = 1;
        this.indices[this.indices.length - 2] = 1;
        this.indices[this.indices.length - 1] = 0;
