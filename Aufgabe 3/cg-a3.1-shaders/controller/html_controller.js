...
define(["jquery", "BufferGeometry", "random", "band", "parametric", "three", "vec2", "robot", "Planet", "Explosion"],
        (function ($, BufferGeometry, Random, Band, ParametricSurface, THREE, vec2, Robot, Planet, Explosion) {
            "use strict";
            /**
...
//                    http://walter.bislins.ch/blog/index.asp?page=Schnittpunkte+zweier+Kreise+berechnen+%28JavaScript%29
                ...
                $("#btnNewPlanet").click(function() {
                    var aColor = new THREE.Color(0.06, 0.06, 0.06);
                    var dColor = new THREE.Color(1, 1, 1);
                    var intensity = 0.2;
                    ...
                    var dLight = new THREE.DirectionalLight(dColor, intensity);
                    dLight.name="dLight";
                    dLight.position.set(0, 0, 1);
                    scene.addLight(dLight);

                    $("#showDay").change(function() {
                        planet.textureSwitch("day")
                    });
                    $("#showNight").change(function() {
                        planet.textureSwitch("night")
                    });
                    $("#showClouds").change(function() {
                        planet.textureSwitch("clouds")
                    });
                });
